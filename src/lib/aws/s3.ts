...
const getS3Client = () => {
  ...
  const accessKeyId = process.env.AWS_ACCESS_KEY_ID || process.env.WS_ACCESS_KEY_ID;
  const secretAccessKey = process.env.AWS_SECRET_ACCESS_KEY || process.env.WS_SECRET_ACCESS_KEY;
