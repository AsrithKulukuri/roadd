          ...
          <div className="bg-bg-card border border-border-default rounded-3xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input name="area" type="number" required value={formData.area} onChange={handleChange} placeholder="e.g. 1500" className="h-12" />
              </div>

              <div className="space-y-2">
                <label className="text-sm font-medium text-text-secondary">Bedrooms</label>
                <select name="bedrooms" value={formData.bedrooms} onChange={handleChange} className="w-full h-12 rounded-xl bg-bg-primary border border-border-default/50 px-4 text-text-primary focus:outline-none focus:ring-2 focus:ring-amber-primary">
              ...
              <div className="space-y-2">
                ...
                <select name="bathrooms" value={formData.bathrooms} onChange={handleChange} className="w-full h-12 rounded-xl bg-bg-primary border border-border-default/50 px-4 text-text-primary focus:outline-none focus:ring-2 focus:ring-amber-primary">
