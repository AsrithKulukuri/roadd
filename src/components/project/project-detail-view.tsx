          ...
          >
            <div className="flex items-center gap-3 px-4 pt-3 pb-3">
              ...
              {whatsapp ? (
                ...
                <button
                  disabled
                  className="flex-1 flex items-center justify-center gap-2 h-12 rounded-2xl font-bold text-sm bg-slate-200 dark:bg-slate-800 text-slate-400 cursor-not-allowed"
                  id="mobile-cta-whatsapp-disabled"
                >
