    ...
    <section id="home-hero-section" className="relative w-full text-slate-900 pb-2 sm:pb-4 min-h-[480px]">
      ...
      <div id="hero-banner-mobile" className="sm:hidden w-full pb-3">
        ...
        <div className="w-full px-4 relative z-30 flex flex-col items-center text-center">
          ...
          {/* Mobile Budget Filter Section - Single compact inline strip */}
          <div className="relative z-20 w-full max-w-[760px] mx-auto mt-2.5 text-left">
            <div className="bg-white/95 backdrop-blur-md border border-slate-200/90 rounded-2xl shadow-xs p-1.5 sm:p-2 flex items-center gap-1.5 sm:gap-2">
              <div className="flex-1 min-w-0">
                <ModernBudgetDropdown
                  ...
                  prefix="MIN"
                  triggerClassName="h-9 sm:h-9.5 px-2.5 sm:px-3 text-xs sm:text-[13px]"
                />
              </div>
              ...
              {(heroBudget[0] !== 1000000 || heroBudget[1] !== 500000000) && (
                <button
                  ...
                  className="w-8 h-8 rounded-full flex items-center justify-center text-slate-400 hover:text-slate-800 hover:bg-slate-100 transition-colors cursor-pointer shrink-0"
              ...
              <button
                type="button"
                onClick={() => handleSearchSubmit()}
                className="h-9 sm:h-9.5 px-3.5 sm:px-4 bg-slate-950 hover:bg-slate-900 active:scale-95 text-white font-extrabold text-xs sm:text-[13px] rounded-full flex items-center justify-center gap-1.5 shadow-xs hover:shadow-sm transition-all cursor-pointer shrink-0"
                aria-label="Apply Budget Filter"
              >
                <span>Apply</span>
                <span className="min-w-[18px] h-[18px] sm:min-w-[20px] sm:h-[20px] px-1 rounded-full bg-amber-500 text-slate-950 flex items-center justify-center text-[10px] sm:text-[11px] font-black shadow-2xs">
                  {matchingCount}
                </span>
              </button>
            </div>
